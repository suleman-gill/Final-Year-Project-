...
PHONEME_TO_ARABIC = {
    ...
    # Space
    "SP": " ",
    # Additional tokens for 80-phoneme vocabulary
    "RAA_TAFKHEEM": "رˤ",
    "RAA_TARQEEQ": "ر",
    "LAM_ALLAH_TAFKHEEM": "لّˤ",
    "LAM_ALLAH_TARQEEQ": "لّ",
    "TAFKHEEM_KHAH": "خˤ",
    "TAFKHEEM_SAD": "صˤ",
    "TAFKHEEM_DAD": "ضˤ",
    "TAFKHEEM_GHAIN": "غˤ",
    ...
    "LAM_QAMARIYYAH": "لᵠ",
    "LAM_SAAKIN_RULE": "لْ",
    "IDGHAM_MUTAMATHILAYN": "ᵈᵐ",
    "IDGHAM_MUTAJANISAYN": "ᵈʲ",
    "IDGHAM_MUTAQARIBAYN": "ᵈᵠ",
    "WAQF_MIM": " ۘ",
    "WAQF_LA": " ۙ",
    "WAQF_JEEM": " ۚ",
    "WAQF_QALI": " ۗ",
...
def main():
    ...
    parser.add_argument("--vocab", type=str, default="vocab_phoneme.json",
                        help="Name of vocabulary file in the data directory")
    ...
    # ------------------------------------------------------------ processor
    # Use the custom or default phoneme vocab
    vocab_path = DATA_DIR / args.vocab
    ...
    print(f"  Vocab tokens     : {len(tokenizer)}")
    print(f"{'=' * 70}\n")
